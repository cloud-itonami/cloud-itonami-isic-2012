# Operator Quickstart — Manufacture of fertilizers and nitrogen compounds

Shortest path from clone to a verified local dry-run for **ISIC 2012** (`cloud-itonami-isic-2012`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2012.git
cd cloud-itonami-isic-2012
```
...
- Blueprint governor key: `fertilizer-plant-operations-governor`
- Likely source path: `fertmfg.governor.cljc`
