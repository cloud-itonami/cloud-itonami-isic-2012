# Business Model: Manufacture of fertilizers and nitrogen compounds
...
## Classification
- Repository: `cloud-itonami-isic-2012` ([github.com/cloud-itonami/cloud-itonami-isic-2012](https://github.com/cloud-itonami/cloud-itonami-isic-2012))
- ISIC Rev.5: `2012` — Manufacture of fertilizers and nitrogen compounds
- Domain: `:fertilizers-nitrogen-compounds/manufacturing`
- Social impact: :worker-safety :environmental-safety :materials-safety :resource-efficiency
- Actor: `:fertilizer-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :fertilizers-nitrogen-compounds/manufacturing — who wants
...
One managed tenant (:fertilizers-nitrogen-compounds/manufacturing):
...
- Do not bypass the `:fertilizer-plant-operations-governor` for production decisions.
