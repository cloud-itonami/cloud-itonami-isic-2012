...
`cloud-itonami-isic-2012` is an OSS open-business blueprint for fertilizer-and-nitrogen-compound plant operations coordination.

## Maintainers
Maintainers may merge changes that preserve these invariants:
- an ammonia-synthesis-reactor/granulation-line action the governor refuses is never dispatched to hardware.
- the Fertilizer Plant Operations Governor remains independent of the advisor.
...
- bypassing ammonia-synthesis-reactor/granulation-line-control or record policy checks
