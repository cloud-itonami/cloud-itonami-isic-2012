(ns fertmfg.phase
  "Phase 0->3 staged rollout for the fertilizer-and-nitrogen-compound
  ...
  consequence (an ammonia-synthesis/granulation-line maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `fertmfg.governor`'s `line-actuate-blocked-violations` HARD-blocks
...
(defn verdict->disposition
  "Map a Fertilizer Plant Operations Governor verdict to a base
